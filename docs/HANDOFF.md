...
| **GitHub Repo** | [github.com/SpyicyDev/bai-website](https://github.com/SpyicyDev/bai-website) | `SpyicyDev/bai-website` (personal scope) | Mack Haymond | `bruinalphainvestment26@gmail.com` | N/A | Private repo. Future: migrate to `bruin-alpha-investment` org and apply for free GitHub Team via faculty advisor at [github.com/edu](https://github.com/edu/teachers) |

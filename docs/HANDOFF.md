...
| **LinkedIn Page**     | [linkedin.com/company/bruin-alpha-investment](https://www.linkedin.com/company/bruin-alpha-investment) | `bruin-alpha-investment`                               | Mack Haymond                 | `bruinalphainvestment26@gmail.com` | N/A          | [LINKEDIN-SETUP.md](./launch/LINKEDIN-SETUP.md)                                                                                                                                                                                                                          |
| **Instagram**         | [instagram.com/bruinalphainvestment](https://www.instagram.com/bruinalphainvestment)                   | `@bruinalphainvestment`                                | Mack Haymond                 | `bruinalphainvestment26@gmail.com` | N/A          | [INSTAGRAM-SETUP.md](./launch/INSTAGRAM-SETUP.md)                                                                                                                                                                                                                        |
...
- `/join`: Recruitment information and off-cycle application status; add the real form URL in Sanity when applications open
...
_Next Ritual Deadline: June 2027_
...
1. Generate a deploy token at `https://www.sanity.io/manage/project/<projectId>/api` → _Tokens_ → _Add API token_ with **Viewer** (read-only) permissions.

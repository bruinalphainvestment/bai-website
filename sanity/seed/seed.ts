...
const IDS = {
  ...
  events: {
    ...
    infoSession: 'event-info-session-fall-2026',
    coffeeChats: 'event-coffee-chats-fall-2026',
    finalRounds: 'event-final-rounds-fall-2026',
    firstMeeting: 'event-first-new-member-meeting-fall-2026',
...
const CLUB_EMAIL = 'info@bruinalphainvestment.com';
const INSTAGRAM_URL = 'https://www.instagram.com/bruinalphainvestment';
...
const joinPageDoc = {
  ...
  // Fall 2026 recruitment schedule.
  timeline: [
    {
      _key: 'join-tl-1',
      _type: 'timelineStep',
      stepNumber: 1,
      title: 'Tue, Sept 22 — EAF & Applications Open',
      body: 'Meet us at the Enormous Activities Fair. The application opens the same day.',
    },
    {
      _key: 'join-tl-2',
      _type: 'timelineStep',
      stepNumber: 2,
      title: 'Wed, Sept 30 — Info Session & Applications Close',
      body: 'Info session from 6:00–7:50 PM. Applications close at the end of the day.',
    },
    {
      _key: 'join-tl-3',
      _type: 'timelineStep',
      stepNumber: 3,
      title: 'Fri–Sat, Oct 2–3 — Coffee Chats',
      body: 'Selected applicants meet members in 1:1 coffee chats.',
    },
    {
      _key: 'join-tl-4',
      _type: 'timelineStep',
  ...
  applicationForm: {
    ...
    body: 'Applications open Tuesday, September 22 and close Wednesday, September 30.',

...
export type ProjectGridSection = {
  ...
  statusFilter?: 'planning' | 'active' | 'completed';
};
...
// Query: *[_type == "homePage"][0] {    title,    seo,    _updatedAt,    sections[] {      _key,      _type,      ...    }  }
...
// Query: *[_type == "joinPage"][0] {    title,    seo,    _updatedAt,    hero,    intro,    applicationProcessHeading,    applicationSteps,    timelineHeading,    timeline,    applicationForm,    faqHeading,    faqs,    contactHeading,    contactLinks,    eligibilityHeading,    eligibilityBullets  }
...
// Query: *[_type == "event"] | order(date asc) {    _id,    name,    date,    endDate,    location,    description,    type,    status,    externalUrl,    "committee": committee->{ _id, name, "slug": slug.current }  }
...
// Query: *[_type == "teamPage"][0] {    title,    seo,    _updatedAt,    hero,    intro,    foundingClassHeading,    membersHeading,    membersPlaceholder,    alumniHeading,    alumniPlaceholder  }
...
// Query: *[_type in [    "homePage",    "aboutPage",    "teamPage",    "projectsPage",    "eventsPage",    "trainingPage",    "joinPage",    "committeesIndexPage"  ]] {    _type,    _updatedAt  }
